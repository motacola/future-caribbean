...
**ID:** `DSP-20260528-001` | **Country:** Caribbean | **Confidence:** 🟡 Validation | 82/100 | B - cross-source
...
**Recommended action:** Prepare operational response: Caribbean. Action window: 48 hours. Evidence: signal detected
**Decision to influence:** Maritime operations adjustment for safety and logistics routing
**Routing rationale:** High-wind + marine alert confirmation requires safety response and shipping route adjustments
