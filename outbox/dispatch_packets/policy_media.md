...
**ID:** `DSP-20260903-021` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260903-029` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-033` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-037` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-041` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-053` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-057` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-077` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-017` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-025` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-045` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-049` | **Country:** Dominica | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-061` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-065` | **Country:** Grenada | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-069` | **Country:** Jamaica | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-073` | **Country:** Jamaica | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-006` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟢 Monitor | 60/100 | C - single-source
