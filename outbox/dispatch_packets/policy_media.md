...
**ID:** `DSP-20260528-016` | **Country:** CARICOM | **Confidence:** 🟡 Validation | 80/100 | B - cross-source
...
**ID:** `DSP-20260528-014` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟢 Monitor | 69/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260528-012` | **Country:** Suriname | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
