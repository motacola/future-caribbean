...
**ID:** `DSP-20260611-016` | **Country:** CARICOM | **Confidence:** 🟡 Validation | 80/100 | B - cross-source
...
**ID:** `DSP-20260611-010` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟡 Validation | 70/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260611-012` | **Country:** Suriname | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
