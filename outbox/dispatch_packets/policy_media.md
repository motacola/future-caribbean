...
**ID:** `DSP-20260827-032` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260827-040` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-060` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-064` | **Country:** Dominica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-076` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-080` | **Country:** Grenada | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-084` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-088` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-012` | **Country:** CARICOM | **Confidence:** 🟡 Validation | 80/100 | B - cross-source
...
**ID:** `DSP-20260827-044` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-048` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-056` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-072` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-036` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-052` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-068` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260827-092` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
