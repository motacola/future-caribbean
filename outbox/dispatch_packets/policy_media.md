...
**ID:** `DSP-20260912-036` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260912-048` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-052` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-056` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-068` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-072` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-092` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 9. CARICOM: food supply indicators shifting — supply chain implications

**ID:** `DSP-20260912-012` | **Country:** CARICOM | **Confidence:** 🟡 Validation | 80/100 | B - cross-source
...
**ID:** `DSP-20260912-084` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 76/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-088` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 76/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-032` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260912-040` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 14. St. Kitts and Nevis: signal detected

**ID:** `DSP-20260912-060` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 15. Dominica: signal detected

**ID:** `DSP-20260912-064` | **Country:** Dominica | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 16. St. Vincent & the Grenadines: signal detected

**ID:** `DSP-20260912-076` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 17. Grenada: signal detected

**ID:** `DSP-20260912-080` | **Country:** Grenada | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 18. St. Vincent and the Grenadines: economic stress indicators rising — portfolio review recommended

**ID:** `DSP-20260912-010` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟢 Monitor | 60/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
