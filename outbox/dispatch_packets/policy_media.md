...
**ID:** `DSP-20260907-027` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260907-035` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-055` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-059` | **Country:** Dominica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-071` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-075` | **Country:** Grenada | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-079` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-083` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-039` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-043` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-051` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-067` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-010` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟢 Monitor | 60/100 | C - single-source
...
**ID:** `DSP-20260907-031` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-047` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-063` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260907-087` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
