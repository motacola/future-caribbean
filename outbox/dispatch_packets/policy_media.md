...
**ID:** `DSP-20260824-036` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260824-044` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-048` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-052` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-056` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-068` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-072` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-092` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-012` | **Country:** CARICOM | **Confidence:** 🟡 Validation | 80/100 | B - cross-source
...
**ID:** `DSP-20260824-032` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-040` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-060` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-064` | **Country:** Dominica | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-076` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-080` | **Country:** Grenada | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-084` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 72/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-088` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 72/100 | C - single-source
**Channel:** Telegram digest | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260824-010` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟢 Monitor | 60/100 | C - single-source
**Channel:** Telegram digest | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
