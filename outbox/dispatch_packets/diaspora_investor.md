...
**ID:** `DSP-20260611-023` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 100/100 | A - multi-source
...
**ID:** `DSP-20260611-026` | **Country:** Belize | **Confidence:** 🔴 Immediate | 100/100 | A - multi-source
**Channel:** Email brief + Telegram | **Window:** 14 days | **Freshness:** sustained
...
**Recommended action:** Investigate Belize as a capital deployment target this cycle. Multi-source validation (701.0% change) confirms directional signal — next step is operator discovery and market entry assessment.
**Decision to influence:** Which verified opportunity to investigate for capital deployment or partnership entry
**Routing rationale:** Multi-source validation reduces screening risk — capital follows verified signals

### 3. St. Vincent and the Grenadines: +88.2% multi-source investment validated — opportunity active

**ID:** `DSP-20260611-029` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🔴 Immediate | 100/100 | A - multi-source
...
**Recommended action:** Investigate St. Vincent and the Grenadines as a capital deployment target this cycle. Multi-source validation (88.2% change) confirms directional signal — next step is operator discovery and market entry assessment.
**Decision to influence:** Which verified opportunity to investigate for capital deployment or partnership entry
**Routing rationale:** Multi-source validation reduces screening risk — capital follows verified signals
...
**ID:** `DSP-20260611-001` | **Country:** Caribwide | **Confidence:** 🟡 Validation | Multi-country | Multi-source
...
**Recommended action:** Screen Caribwide for investment readiness. FDI movement (Guyana (860.3% change), Belize (701.0% change), St. Vincent and the Grenadines (88.2% change)) is a screening trigger — cross-reference with sector conditions before deploying capital.
...
**ID:** `DSP-20260611-003` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 90/100 | B - cross-source
**Channel:** Email brief + Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260611-005` | **Country:** Belize | **Confidence:** 🔴 Immediate | 90/100 | B - cross-source
**Channel:** Email brief + Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260611-020` | **Country:** Caribwide | **Confidence:** 🟡 Validation | Multi-country | Multi-source
**Channel:** Email brief + Telegram | **Window:** 14 days | **Freshness:** new
**Feedback status:** ignored
...
**ID:** `DSP-20260611-007` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟡 Validation | 78/100 | B - cross-source
**Channel:** Email brief + Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**Recommended action:** Screen St. Vincent and the Grenadines for investment readiness. FDI movement (88.2% change) is a screening trigger — cross-reference with sector conditions before deploying capital.
**Decision to influence:** Which country-sector pair to validate for investment readiness
**Routing rationale:** Single-source FDI movement is a screening trigger, not a deployment signal — start diligence

### 9. St. Vincent and the Grenadines: economic stress indicators rising — portfolio review recommended

**ID:** `DSP-20260611-009` | **Country:** St. Vincent and the Grenadines | **Confidence:** 🟡 Validation | 70/100 | C - single-source
...
**ID:** `DSP-20260611-011` | **Country:** Suriname | **Confidence:** 🟢 Monitor | 56/100 | C - single-source
**Channel:** Email brief + Telegram | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
...
**Recommended action:** Assess portfolio exposure in Suriname. Economic stress indicators (16.23%) may affect existing positions or timing.
**Decision to influence:** Risk assessment for capital exposure or policy attention
**Routing rationale:** Vulnerability signals change risk profiles — reassess exposure and timing
