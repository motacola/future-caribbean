...
**ID:** `DSP-20260901-018` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 100/100 | C - single-source
...
**ID:** `DSP-20260901-021` | **Country:** Suriname | **Confidence:** 🔴 Immediate | 96/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-015` | **Country:** Caribwide | **Confidence:** 🟡 Validation | Multi-country | Multi-source
...
### 4. Anguilla: signal detected

**ID:** `DSP-20260901-037` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260901-057` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-061` | **Country:** Dominica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-073` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-077` | **Country:** Grenada | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-081` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-085` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 11. Barbados: +34.8% FDI momentum validated — cross-reference before deploying

**ID:** `DSP-20260901-024` | **Country:** Barbados | **Confidence:** 🟡 Validation | 83/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 12. Turks and Caicos Islands: signal detected

**ID:** `DSP-20260901-029` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 78/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-091` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 76/100 | C - single-source
...
**ID:** `DSP-20260901-041` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-045` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-053` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-069` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-033` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-049` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-065` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260901-089` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
