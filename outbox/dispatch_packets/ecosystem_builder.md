...
**ID:** `DSP-20260903-011` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 100/100 | C - single-source
...
**ID:** `DSP-20260903-014` | **Country:** Suriname | **Confidence:** 🔴 Immediate | 96/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 3. Haiti: signal detected

**ID:** `DSP-20260903-023` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260903-031` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-035` | **Country:** Barbados | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-039` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-043` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-055` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-059` | **Country:** Nicaragua | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-079` | **Country:** Haiti | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 11. Turks and Caicos Islands: signal detected

**ID:** `DSP-20260903-019` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 12. Anguilla: signal detected

**ID:** `DSP-20260903-027` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-047` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-051` | **Country:** Dominica | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 15. St. Vincent & the Grenadines: signal detected

**ID:** `DSP-20260903-063` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 16. Grenada: signal detected

**ID:** `DSP-20260903-067` | **Country:** Grenada | **Confidence:** 🟡 Validation | 74/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
### 17. Eastern Caribbean Currency Union: 4.6%

**ID:** `DSP-20260903-081` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 72/100 | C - single-source
...
### 18. Jamaica: signal detected

**ID:** `DSP-20260903-071` | **Country:** Jamaica | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260903-075` | **Country:** Jamaica | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
