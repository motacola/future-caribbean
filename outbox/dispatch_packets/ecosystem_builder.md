...
**ID:** `DSP-20260831-018` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 100/100 | C - single-source
...
**ID:** `DSP-20260831-021` | **Country:** Suriname | **Confidence:** 🔴 Immediate | 96/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-015` | **Country:** Caribwide | **Confidence:** 🟡 Validation | Multi-country | Multi-source
...
**ID:** `DSP-20260831-029` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260831-037` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-057` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-061` | **Country:** Dominica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-073` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-077` | **Country:** Grenada | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-081` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-085` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-024` | **Country:** Barbados | **Confidence:** 🟡 Validation | 83/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-091` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 76/100 | C - single-source
...
**ID:** `DSP-20260831-041` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-045` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-053` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-069` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-033` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-049` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-065` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260831-089` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
