...
**ID:** `DSP-20260908-018` | **Country:** Guyana | **Confidence:** 🔴 Immediate | 100/100 | C - single-source
...
**ID:** `DSP-20260908-021` | **Country:** Suriname | **Confidence:** 🔴 Immediate | 96/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-015` | **Country:** Caribwide | **Confidence:** 🟡 Validation | Multi-country | Multi-source
...
**ID:** `DSP-20260908-029` | **Country:** Turks and Caicos Islands | **Confidence:** 🟡 Validation | 84/100 | C - single-source
...
**ID:** `DSP-20260908-037` | **Country:** Anguilla | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-057` | **Country:** St. Kitts and Nevis | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-061` | **Country:** Dominica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-073` | **Country:** St. Vincent & the Grenadines | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-077` | **Country:** Grenada | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-081` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-085` | **Country:** Jamaica | **Confidence:** 🟡 Validation | 84/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-024` | **Country:** Barbados | **Confidence:** 🟡 Validation | 83/100 | C - single-source
**Channel:** Telegram | **Window:** 14 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-091` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 76/100 | C - single-source
...
**ID:** `DSP-20260908-041` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-045` | **Country:** Barbados | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-053` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-069` | **Country:** Nicaragua | **Confidence:** 🟢 Monitor | 66/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-033` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-049` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-065` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
...
**ID:** `DSP-20260908-089` | **Country:** Haiti | **Confidence:** 🟢 Monitor | 50/100 | C - single-source
**Channel:** Telegram | **Window:** 7 days | **Freshness:** sustained
**Feedback status:** ignored
