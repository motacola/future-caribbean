...
**ID:** `DSP-20260816-013` | **Country:** CARICOM | **Confidence:** 🔴 Immediate | 95/100 | B - cross-source
...
### 2. Eastern Caribbean Currency Union: 5.8%

**ID:** `DSP-20260816-211` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 76/100 | C - single-source
...
**ID:** `DSP-20260816-214` | **Country:** Eastern Caribbean Currency Union | **Confidence:** 🟡 Validation | 72/100 | C - single-source
**Channel:** Telegram | **Window:** 30 days | **Freshness:** sustained
**Feedback status:** ignored
