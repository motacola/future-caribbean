...
- Signal: `enhanced-invest-guyana` · Dispatch: `DSP-20260610-023`
...
- Construction and infrastructure — _Analyst prior from widely reported sector drivers — requires local confirmation_
- Logistics serving the energy supply chain — _Analyst prior from widely reported sector drivers — requires local confirmation_
- Agriculture and agro-processing — _Analyst prior from widely reported sector drivers — requires local confirmation_
- Sector mix verifiable from official GDP-by-industry data — _CARICOM Statistics: Guyana Value added|GDP by industries at constant prices (ISIC 4), GYD: 2012-2023_
- FDI-receiving sectors (composition not yet broken down) — _World Bank: FDI net inflows moved +860.3% from 2023 to 2024_
