...
|---|---|---|---|
| Regional Founder/Operator | Telegram | Assess competitive positioning in Guyana. FDI movement (860.3% change) signals growing market or incoming competition — evaluate… | ignored (`DSP-20260528-025`) |
| Ecosystem Builder | Telegram | Route Guyana opportunity to relevant founders and investors in your network. Signal strength (860.3% change) makes this a… | ignored (`DSP-20260528-024`) |
| Diaspora Investor | Email brief + Telegram | Investigate Guyana as a capital deployment target this cycle. Multi-source validation (860.3% change) confirms directional signal —… | forwarded (`DSP-20260528-023`) |
...
| Persona | Channel | Next action | Feedback |
|---|---|---|---|
| Regional Founder/Operator | Telegram | Assess competitive positioning in Belize. FDI movement (701.0% change) signals growing market or incoming competition — evaluate… | ignored (`DSP-20260528-028`) |
| Ecosystem Builder | Telegram | Route Belize opportunity to relevant founders and investors in your network. Signal strength (701.0% change) makes this a… | ignored (`DSP-20260528-027`) |
| Diaspora Investor | Email brief + Telegram | Investigate Belize as a capital deployment target this cycle. Multi-source validation (701.0% change) confirms directional signal —… | opened (`DSP-20260528-026`) |
...
| Persona | Channel | Next action | Feedback |
|---|---|---|---|
| Regional Founder/Operator | Telegram | Assess competitive positioning in St. Vincent and the Grenadines. FDI movement (88.2% change) signals growing market or incoming… | ignored (`DSP-20260528-031`) |
| Ecosystem Builder | Telegram | Route St. Vincent and the Grenadines opportunity to relevant founders and investors in your network. Signal strength (88.2% change)… | ignored (`DSP-20260528-030`) |
| Diaspora Investor | Email brief + Telegram | Investigate St. Vincent and the Grenadines as a capital deployment target this cycle. Multi-source validation (88.2% change) confirms… | ignored (`DSP-20260528-029`) |
...
| Persona | Channel | Next action | Feedback |
|---|---|---|---|
| Regional Operator | Telegram | Review operational readiness for CARICOM opportunities. CDB active procurement notices: 6 — assess capacity and bid pipeline. | replied (`DSP-20260528-017`) |
| Regional Founder/Operator | Telegram | Map CARICOM procurement pipeline against your capability. CDB/IDB projects (CDB active procurement notices: 6) create service and… | ignored (`DSP-20260528-019`) |
| Procurement Watcher | Email brief | Track CDB/IDB project pipeline: CDB active procurement notices: 6. Review opportunity fit and prepare expression of interest. | ignored (`DSP-20260528-018`) |
...
| Persona | Channel | Next action | Feedback |
|---|---|---|---|
| Regional Founder/Operator | Telegram | Assess competitive positioning in Caribwide. FDI movement (Guyana (860.3% change), Belize (701.0% change), St. Vincent and the… | ignored (`DSP-20260528-022`) |
| Ecosystem Builder | Telegram | Route Caribwide opportunity to relevant founders and investors in your network. Signal strength (Guyana (860.3% change), Belize… | ignored (`DSP-20260528-021`) |
| Diaspora Investor | Email brief + Telegram | Investigate Caribwide as a capital deployment target this cycle. Multi-source validation (Guyana (860.3% change), Belize (701.0%… | ignored (`DSP-20260528-020`) |
