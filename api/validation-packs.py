        ...
        if sid == "bundle":
            ...
            with zipfile.ZipFile(buf, "w", zipfile.ZIP_DEFLATED) as zf:
                ...
                if index is not None:
                    zf.writestr(
                        "README.txt",
                        "Signal Fabric validation packs — pre-assembled diligence artifacts.\n"
            ...
            self.send_header("Content-Disposition", 'attachment; filename="signal-fabric-validation-packs.zip"')
            self.send_header("Content-Length", str(len(body)))
            self.send_header("Access-Control-Allow-Origin", "*")
            self.end_headers()
            self.wfile.write(body)
